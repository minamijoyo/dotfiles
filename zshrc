...
alias sbxc='(){ sbx create ccbase --name $(basename $(pwd)) --kit ~/src/github.com/minamijoyo/dotfiles/sbx/kits/ccbase ~/src/github.com/minamijoyo/dotfiles/sbx/kits/cato . }'
